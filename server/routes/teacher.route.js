...
import { googleSignIn, isAuth, profileCompletion, teamApprove, teamRequest,
teacherLogin, getTeamLogsheets, deleteTeam, 
checkLogEntry, requestLogCorrection, createMyProject, getMyProjects, getProjectApplicants,
  updateMyProject, deleteMyProject, handleStudentApplication,} from '../controllers/teacher.control.js';
...
teacherRouter.post("/my-projects", authTeacher, createMyProject);
teacherRouter.get("/my-projects", authTeacher, getMyProjects);
teacherRouter.get("/my-projects/:projectId/applicants", authTeacher, getProjectApplicants);
teacherRouter.put("/my-projects/:projectId", authTeacher, updateMyProject);
teacherRouter.delete("/my-projects/:projectId", authTeacher, deleteMyProject);
teacherRouter.post("/my-projects/:projectId/applicants/:studentId", authTeacher,
